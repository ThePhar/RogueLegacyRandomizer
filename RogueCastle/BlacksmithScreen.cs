...
namespace RogueCastle
{
	public class BlacksmithScreen : Screen
	{
		...
		private void InitializeTextObjs()
		{
			...
			m_textInfoTitleContainer.Position = new Vector2(m_blacksmithUI.X + 205f, m_blacksmithUI.Y - m_blacksmithUI.Height / 2 + 45f);
			...
			m_addPropertiesText.Position = new Vector2(m_addPropertiesTitleText.X, m_addPropertiesTitleText.Bounds.Bottom);

...
namespace RogueCastle
{
	public class EquipmentSystem
	{
		...
		public void InitializeEquipmentData()
		{
			...
			CreateEquipmentData(4, 3, 2, 0, 300, 10, 0, 0, 0, 0, 0, new Color(255, 221, 130), new Color(0, 0, 0), new Vector2(1f, 0.04f));
			...
			CreateEquipmentData(4, 5, 0, 5, 425, 15, 0, 0, 0, 0, 0, new Color(125, 235, 80), new Color(0, 0, 0), new Vector2(2f, 0.15f));
			...
			CreateEquipmentData(0, 1, 2, 10, 500, 35, -30, 9, 0, 0, 0, new Color(105, 0, 0), new Color(105, 0, 0), new Vector2(7f, 1f));
			CreateEquipmentData(1, 1, 3, 10, 500, 35, -30, 0, 0, 25, 0, new Color(230, 0, 0), new Color(105, 0, 0), new Vector2(7f, 1f));
			CreateEquipmentData(4, 1, 2, 10, 500, 35, -30, 0, 0, 0, 0, new Color(230, 0, 0), new Color(0, 0, 0), new Vector2(7f, 1f));
			CreateEquipmentData(3, 1, 3, 10, 500, 35, -30, 0, 0, 0, 9, new Color(230, 0, 0), new Color(105, 0, 0), new Vector2(7f, 1f));
			CreateEquipmentData(2, 1, 2, 10, 500, 35, -30, 0, 14, 0, 0, new Color(230, 0, 0), new Color(105, 0, 0), new Vector2(7f, 1f));
			...
			CreateEquipmentData(4, 11, 2, 1, 850, 35, 0, 0, 0, 0, 0, new Color(245, 255, 175), new Color(0, 0, 0), new Vector2(8f, 1f));
			...
			CreateEquipmentData(4, 13, 2, 6, 1300, 40, 0, 0, 0, 0, 0, new Color(135, 200, 130), new Color(0, 0, 0), new Vector2(1f, 0.04f), new Vector2(2f, 0.15f));
			...
			CreateEquipmentData(0, 10, 2, 11, 1250, 45, 0, -10, 0, 0, 0, new Color(240, 235, 90), new Color(215, 135, 75), new Vector2(3f, 0.1f));
			CreateEquipmentData(1, 10, 3, 11, 1250, 45, 0, -10, 0, 0, 0, new Color(240, 235, 90), new Color(215, 135, 75), new Vector2(3f, 0.1f));
			CreateEquipmentData(4, 10, 3, 11, 1250, 75, 0, 0, 0, 0, 0, new Color(210, 240, 75), new Color(0, 0, 0), new Vector2(3f, 0.1f));
			CreateEquipmentData(3, 10, 2, 11, 1250, 45, 0, -10, 0, 0, 0, new Color(235, 220, 135), new Color(235, 220, 135), new Vector2(3f, 0.1f));
			CreateEquipmentData(2, 10, 3, 11, 1250, 45, 0, -10, 0, 0, 0, new Color(240, 235, 90), new Color(235, 135, 75), new Vector2(3f, 0.1f));
			...
			CreateEquipmentData(0, 21, 2, 7, 1700, 45, 0, 27, 0, 0, 0, new Color(170, 255, 250), new Color(255, 245, 255));
			CreateEquipmentData(1, 18, 0, 7, 1500, 40, 40, 0, 0, 45, 0, new Color(115, 175, 185), new Color(255, 245, 255));
			CreateEquipmentData(4, 23, 2, 7, 2100, 55, 0, 0, 0, 0, 0, new Color(170, 255, 250), new Color(0, 0, 0), new Vector2(9f, 2f));
			CreateEquipmentData(3, 18, 0, 7, 1800, 50, 0, 0, 0, 0, 32, new Color(255, 245, 255), new Color(255, 245, 255));
			CreateEquipmentData(2, 18, 0, 7, 1650, 65, 0, 0, 48, 0, 0, new Color(115, 175, 185), new Color(170, 255, 250));
			CreateEquipmentData(0, 20, 3, 12, 1600, 50, 0, 15, -15, 0, 0, new Color(60, 60, 60), new Color(30, 30, 30), new Vector2(4f, 0.5f));
			CreateEquipmentData(1, 20, 3, 12, 1400, 50, 30, 0, -15, 30, 0, new Color(90, 90, 90), new Color(30, 30, 30), new Vector2(4f, 0.5f));
			CreateEquipmentData(4, 20, 2, 12, 1800, 35, 0, 0, -15, 0, 0, new Color(85, 15, 5), new Color(0, 0, 0), new Vector2(4f, 0.5f));
			CreateEquipmentData(3, 20, 3, 12, 1500, 50, 0, 0, -15, 0, 15, new Color(30, 30, 30), new Color(90, 90, 90), new Vector2(4f, 0.5f));
			CreateEquipmentData(2, 20, 2, 12, 1850, 50, 30, 0, -15, 30, 0, new Color(90, 90, 90), new Color(30, 30, 30), new Vector2(4f, 0.5f));
			...
			CreateEquipmentData(4, 29, 2, 3, 2600, 55, 0, 0, 0, 0, 0, new Color(55, 0, 145), new Color(0, 0, 0), new Vector2(2f, 0.5f));
			...
			CreateEquipmentData(4, 34, 3, 8, 3200, 75, 0, 0, 0, 0, 0, new Color(255, 0, 0), new Color(0, 0, 0), new Vector2(7f, 2f));
			...
			CreateEquipmentData(0, 30, 3, 13, 3200, 55, 0, 20, 0, 25, 0, new Color(215, 245, 70), new Color(255, 255, 255), new Vector2(8f, 1f));
			CreateEquipmentData(1, 30, 3, 13, 2800, 55, 25, 0, 0, 50, 0, new Color(215, 245, 70), new Color(255, 255, 255), new Vector2(8f, 1f));
			CreateEquipmentData(4, 30, 3, 13, 3300, 65, 0, 0, 0, 25, 0, new Color(215, 245, 70), new Color(0, 0, 0), new Vector2(8f, 1f));
			CreateEquipmentData(3, 30, 3, 13, 3000, 100, 0, 0, 0, 25, 72, new Color(215, 245, 70), new Color(255, 255, 255), new Vector2(8f, 1f));
			CreateEquipmentData(2, 30, 2, 13, 3800, 65, 0, 0, 40, 25, 0, new Color(215, 245, 70), new Color(255, 255, 255), new Vector2(8f, 1f));
			CreateEquipmentData(0, 40, 3, 4, 4250, 85, 0, 60, 0, 0, 0, new Color(20, 60, 255), new Color(255, 40, 40));
			CreateEquipmentData(1, 38, 0, 4, 3750, 70, 90, 0, 0, 90, 0, new Color(180, 180, 180), new Color(110, 100, 240));
			CreateEquipmentData(4, 43, 2, 4, 4100, 80, 0, 0, 0, 0, 0, new Color(255, 255, 255), new Color(0, 0, 0), new Vector2(15f, 3f));
			CreateEquipmentData(3, 38, 0, 4, 3800, 85, 0, 0, 0, 0, 60, new Color(150, 150, 150), new Color(120, 120, 120));
			CreateEquipmentData(2, 38, 2, 4, 4500, 125, 0, 0, 100, 0, 0, new Color(120, 120, 120), new Color(105, 80, 240));
			CreateEquipmentData(0, 52, 2, 9, 4750, 75, 0, 40, 0, 0, 0, new Color(125, 125, 125), new Color(60, 130, 70), new Vector2(1f, 0.04f), new Vector2(2f, 0.15f), new Vector2(4f, 0.5f));
			CreateEquipmentData(1, 49, 2, 9, 3900, 65, 40, 0, 0, 40, 0, new Color(255, 255, 255), new Color(70, 70, 70), new Vector2(1f, 0.04f), new Vector2(2f, 0.15f), new Vector2(4f, 0.5f));
			CreateEquipmentData(4, 57, 2, 9, 5750, 85, 0, 0, 0, 0, 0, new Color(255, 250, 120), new Color(0, 0, 0), new Vector2(1f, 0.04f), new Vector2(2f, 0.15f), new Vector2(4f, 0.5f));
			CreateEquipmentData(3, 46, 2, 9, 4600, 60, 0, 0, 0, 0, 40, new Color(255, 255, 255), new Color(70, 70, 70), new Vector2(1f, 0.04f), new Vector2(2f, 0.15f), new Vector2(4f, 0.5f));
			CreateEquipmentData(2, 46, 2, 9, 6750, 140, 0, 0, 50, 0, 0, new Color(255, 255, 255), new Color(70, 70, 70), new Vector2(1f, 0.04f), new Vector2(2f, 0.15f), new Vector2(4f, 0.5f));
			CreateEquipmentData(0, 50, 3, 14, 6000, 100, 0, 50, 0, 0, 0, new Color(15, 15, 15), new Color(15, 15, 15), new Vector2(7f, 1f), new Vector2(8f, 1f), new Vector2(11f, 1f));
			CreateEquipmentData(1, 50, 3, 14, 6000, 100, 60, 0, 0, 60, 0, new Color(45, 45, 45), new Color(15, 15, 15), new Vector2(7f, 1f), new Vector2(8f, 1f), new Vector2(9f, 1f));
			CreateEquipmentData(4, 50, 3, 14, 6000, 100, 0, 0, 0, 0, 0, new Color(15, 15, 15), new Color(15, 15, 15), new Vector2(7f, 1f), new Vector2(8f, 1f), new Vector2(9f, 1f));
			CreateEquipmentData(3, 50, 3, 14, 6000, 100, 0, 0, 0, 0, 50, new Color(45, 45, 45), new Color(45, 45, 45), new Vector2(7f, 1f), new Vector2(8f, 1f), new Vector2(9f, 1f));
			CreateEquipmentData(2, 50, 3, 14, 6000, 100, 50, 0, 0, 0, 0, new Color(15, 15, 15), new Color(15, 15, 15), new Vector2(7f, 1f), new Vector2(8f, 1f), new Vector2(11f, 1f));
		}

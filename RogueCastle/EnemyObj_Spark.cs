...
namespace RogueCastle
{
	public class EnemyObj_Spark : EnemyObj
	{
		...
		private Rectangle TopRect
		{
			get
			{
				return new Rectangle(Bounds.Left + m_collisionBoxSize, Bounds.Top, Width - m_collisionBoxSize * 2, m_collisionBoxSize);
			}
		}
		private Rectangle BottomRect
		{
			get
			{
				return new Rectangle(Bounds.Left + m_collisionBoxSize, Bounds.Bottom - m_collisionBoxSize, Width - m_collisionBoxSize * 2, m_collisionBoxSize);
			}
		}
		private Rectangle LeftRect
		{
			get
			{
				return new Rectangle(Bounds.Left, Bounds.Top + m_collisionBoxSize, m_collisionBoxSize, Height - m_collisionBoxSize * 2);
			}
		}
		private Rectangle RightRect
		{
			get
			{
				return new Rectangle(Bounds.Right - m_collisionBoxSize, Bounds.Top + m_collisionBoxSize, m_collisionBoxSize, Height - m_collisionBoxSize * 2);
			}
		}
		...
		private Rectangle TopRightPoint
		{
			get
			{
				return new Rectangle(Bounds.Right - m_collisionBoxSize, Bounds.Top, m_collisionBoxSize, m_collisionBoxSize);
			}
		}
		private Rectangle BottomLeftPoint
		{
			get
			{
				return new Rectangle(Bounds.Left, Bounds.Bottom - m_collisionBoxSize, m_collisionBoxSize, m_collisionBoxSize);
			}
		}
		private Rectangle BottomRightPoint
		{
			get
			{
				return new Rectangle(Bounds.Right - m_collisionBoxSize, Bounds.Bottom - m_collisionBoxSize, m_collisionBoxSize, m_collisionBoxSize);
			}
		}
		...
		public void HookToGround()
		{
			...
			{
				if (current.Y >= Y && current.Y - Y < num && CollisionMath.Intersects(current.Bounds, new Rectangle((int)X, (int)(Y + (current.Y - Y) + 5f), Width, Height / 2)))
				{
					num = current.Y - Y;
					terrainObj = current;
				}

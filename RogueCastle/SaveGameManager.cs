...
namespace RogueCastle
{
	public class SaveGameManager
	{
		...
		private void PerformDirectoryCheck()
		{
			...
			if (!this.m_storageContainer.DirectoryExists("Profile1"))
			{
				this.m_storageContainer.CreateDirectory("Profile1");
				this.CopyFile(this.m_storageContainer, this.m_fileNamePlayer, "Profile1");
				this.CopyFile(this.m_storageContainer, "AutoSave_" + this.m_fileNamePlayer, "Profile1");
				this.CopyFile(this.m_storageContainer, this.m_fileNameUpgrades, "Profile1");
				this.CopyFile(this.m_storageContainer, "AutoSave_" + this.m_fileNameUpgrades, "Profile1");
				this.CopyFile(this.m_storageContainer, this.m_fileNameMap, "Profile1");
				this.CopyFile(this.m_storageContainer, "AutoSave_" + this.m_fileNameMap, "Profile1");
				this.CopyFile(this.m_storageContainer, this.m_fileNameMapData, "Profile1");
				this.CopyFile(this.m_storageContainer, "AutoSave_" + this.m_fileNameMapData, "Profile1");
				this.CopyFile(this.m_storageContainer, this.m_fileNameLineage, "Profile1");
				this.CopyFile(this.m_storageContainer, "AutoSave_" + this.m_fileNameLineage, "Profile1");
			}
			if (!this.m_storageContainer.DirectoryExists("Profile2"))
			{
				this.m_storageContainer.CreateDirectory("Profile2");
			}
			if (!this.m_storageContainer.DirectoryExists("Profile3"))
			{
				this.m_storageContainer.CreateDirectory("Profile3");
			}
			this.m_storageContainer.Dispose();
			this.m_storageContainer = null;
		}
		...
		public void SaveAllFileTypes(bool saveBackup)
		{
			...
			this.SaveBackupFiles(new SaveType[]
			{
				SaveType.PlayerData,
				SaveType.UpgradeData,
				SaveType.Map,
		...
		{
			this.LoadFiles(level, new SaveType[]
			{
				SaveType.PlayerData,
				SaveType.UpgradeData,
				SaveType.Map,
		...
		public void ClearAllFileTypes(bool deleteBackups)
		{
			...
			this.ClearBackupFiles(new SaveType[]
			{
				SaveType.PlayerData,
				SaveType.UpgradeData,
				SaveType.Map,
		...
		private void DeleteData(SaveType deleteType)
		{
			...
			case SaveType.PlayerData:
				...
				{
					this.m_storageContainer.DeleteFile(string.Concat(new object[]
					{
						"Profile",
						Game.GameConfig.ProfileSlot,
						"/",
		...
		private void SaveData(SaveType saveType, bool saveBackup)
		{
			...
			{
			case SaveType.PlayerData:
				this.SavePlayerData(saveBackup);
				break;
			case SaveType.UpgradeData:
				this.SaveUpgradeData(saveBackup);
				break;
			case SaveType.Map:
				this.SaveMap(saveBackup);
				break;
			case SaveType.MapData:
				this.SaveMapData(saveBackup);
				break;
			case SaveType.Lineage:
				this.SaveLineageData(saveBackup);
				break;
			}
		...
		{
			string text = this.m_fileNamePlayer;
			if (saveBackup)
			{
				text = text.Insert(0, "AutoSave_");
			}
			text = text.Insert(0, "Profile" + Game.GameConfig.ProfileSlot + "/");
			using (Stream stream = this.m_storageContainer.CreateFile(text))
			{
		...
		{
			string text = this.m_fileNameUpgrades;
			if (saveBackup)
			{
				text = text.Insert(0, "AutoSave_");
			}
		...
		{
			string text = this.m_fileNameMap;
			if (saveBackup)
			{
				text = text.Insert(0, "AutoSave_");
			}
		...
		{
			string text = this.m_fileNameMapData;
			if (saveBackup)
			{
				text = text.Insert(0, "AutoSave_");
			}
		...
		{
			string text = this.m_fileNameLineage;
			if (saveBackup)
			{
				text = text.Insert(0, "AutoSave_");
			}
		...
		{
			using (Stream stream = this.m_storageContainer.OpenFile(string.Concat(new object[]
			{
				"Profile",
				Game.GameConfig.ProfileSlot,
				"/",
			...
			}), FileMode.Open, FileAccess.Read, FileShare.Read))
			{
				using (BinaryReader binaryReader = new BinaryReader(stream))
				{
					...
					Game.PlayerStats.Traits = new Vector2((float)binaryReader.ReadByte(), (float)binaryReader.ReadByte());
					...
					Game.PlayerStats.WizardSpellList = new Vector3((float)b, (float)b2, (float)b3);
					if (LevelEV.SHOW_SAVELOAD_DEBUG_TEXT)
					{
					...
					for (int i = 0; i < 34; i++)
					{
						Vector4 value = new Vector4((float)binaryReader.ReadByte(), (float)binaryReader.ReadByte(), (float)binaryReader.ReadByte(), (float)binaryReader.ReadByte());
					...
					{
						Vector2 item = new Vector2((float)binaryReader.ReadInt32(), (float)binaryReader.ReadInt32());
		...
		public ProceduralLevelScreen LoadMap()
		{
			...
			}), FileMode.Open, FileAccess.Read, FileShare.Read))
			{
				using (BinaryReader binaryReader = new BinaryReader(stream))
				{
					...
					for (int i = 0; i < num; i++)
					{
						array[i].W = (float)binaryReader.ReadInt32();
						array[i].X = (float)binaryReader.ReadByte();
						array[i].Y = (float)binaryReader.ReadInt32();
						array[i].Z = (float)binaryReader.ReadInt32();
						array2[i].X = (float)binaryReader.ReadByte();
						array2[i].Y = (float)binaryReader.ReadByte();
						array2[i].Z = (float)binaryReader.ReadByte();
					}
				...
				using (BinaryReader binaryReader = new BinaryReader(stream))
				{
					...
					for (int i = 0; i < num; i++)
					{
						list.Add(new PlayerLineageData
						{
							...
							Traits = new Vector2((float)binaryReader.ReadByte(), (float)binaryReader.ReadByte()),
					...
					for (int k = 0; k < num2; k++)
					{
						...
						item.Traits.X = (float)binaryReader.ReadByte();
						item.Traits.Y = (float)binaryReader.ReadByte();
		...
		{
			return this.m_storageContainer;
		}
		public void GetSaveHeader(byte profile, out byte playerClass, out string playerName, out int playerLevel, out bool playerIsDead, out int castlesBeaten)
		{
			...
			{
				using (Stream stream2 = this.m_storageContainer.OpenFile(string.Concat(new object[]
				{
					"Profile",
					profile,
					"/",

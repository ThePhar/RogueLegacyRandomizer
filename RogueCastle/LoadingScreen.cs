	...
	public class LoadingScreen : Screen
	{
		...
		public void EndLoading()
		{
			...
			if (m_screenTypeToLoad == 15)
			{
				...
				ScreenManager.AddScreen(m_levelToLoad, new PlayerIndex?(PlayerIndex.One));
				if (Game.PlayerStats.IsDead)
				{
					ScreenManager.AddScreen((ScreenManager as RCScreenManager).SkillScreen, new PlayerIndex?(PlayerIndex.One));
			...
			ScreenManager.AddScreen(this, new PlayerIndex?(PlayerIndex.One));
			AddFinalTransition();
		}

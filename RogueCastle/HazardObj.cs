...
namespace RogueCastle
{
	public class HazardObj : PhysicsObj, IDealsDamageObj
	{
		...
		{
			camera.Draw(m_texture, Position, new Rectangle?(new Rectangle(0, 0, (int)(Width / 60f * 64f), Height)), TextureColor, MathHelper.ToRadians(Rotation), Vector2.Zero, Scale, SpriteEffects.None, 1f);
		}

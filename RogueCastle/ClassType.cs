    ...
    internal class ClassType
    {
        ...
        public static string ProfileCardDescription(byte classType)
        {
            switch (classType)
            {
                ...
                case 3:
                    return string.Concat("+", 15.000001f, "% Crit. Chance, +", 125f,
                        "% Crit. Damage.\nLow HP, MP, and Str.");
                case 4:
                    return "Huge Str, but you cannot land critical strikes.\n +" + 30.0000019f +
                           "% Move Speed.  Low HP and MP.";
                case 5:
                ...
                case 14:
                    return "SPECIAL: Empowered Spell.\n" + 30.0000019f +
                           "% of damage dealt is converted into mana.\nLow Str, HP, and MP.";
                case 15:
                    return

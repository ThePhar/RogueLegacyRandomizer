...
public class SlotData
{
    ...
    public List<string> AdditionalSirNames => (_slotData["additional_sir_names"] as JArray ?? new JArray())
        .Select(s => s.ToString())
        .ToList();

    public List<string> AdditionalLadyNames => (_slotData["additional_lady_names"] as JArray ?? new JArray())

//  RogueLegacyRandomizer - ChallengeBossRoomObj.cs
...
public abstract class ChallengeBossRoomObj : RoomObj
{
    ...
    public override void Initialize()
    {
        ...
        {
            var raindropObj =
                new RaindropObj(new(CDGMath.RandomFloat(X - Width, X), CDGMath.RandomFloat(Y, Y + Height)));
    ...
    public void DisplayBossTitle(string bossTitle1, string bossTitle2, string endHandler)
    {
        ...
        {
            _bossTitle1.Position = new(camera.X - 550f, camera.Y + 100f);
        }
        else
        {
            _bossTitle1.Position = new(camera.X - 550f, camera.Y + 50f);
        }

// Rogue Legacy Randomizer - JukeboxBonusRoom.cs
    ...
    public override void Update(GameTime gameTime)
    {
        if (CollisionMath.Intersects(Player.Bounds, m_jukeBox.Bounds))
        {
            ...
            if (Game.GlobalInput.JustPressed(16) || Game.GlobalInput.JustPressed(17))
            {
                ...
                m_songIndex++;
                if (m_songIndex > m_songList.Length - 1) m_songIndex = 0;

                AnimateJukebox();
                CheckForSongRepeat();

                // Check location.
                Program.Game.CollectItemFromLocation(LocationCode.JUKEBOX_REWARD);
            }
        }
        else
        {

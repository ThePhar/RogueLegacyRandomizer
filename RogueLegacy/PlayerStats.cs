...
//  Last Modified 2023-10-26 1:52 PM
//
...
public class PlayerStats : IDisposableObj
{
    ...
    public PlayerStats()
    {
        ...
        IsFemale = false;
        TimesCastleBeaten = 0;
        EnemiesKilledList = new();
        WizardSpellList = new(1f, 2f, 8f);
        Traits = new(0f, 0f);
        Gold = 0;
        CurrentLevel = 0;
        HeadPiece = 1;
        ...
        // Don't let them predict your next move.
    ...
    public bool         ReadStartingDiary         { get; set; }

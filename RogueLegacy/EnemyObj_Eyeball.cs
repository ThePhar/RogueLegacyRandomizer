...
public class EnemyObj_Eyeball : EnemyObj
{
    ...
    protected override void InitializeEV()
    {
        ...
        if (Difficulty == EnemyDifficulty.MiniBoss) m_resetSpriteName = "EnemyEyeballBossEye_Character";
    }
    ...
    public override void Kill(bool giveXP = true)
    {
        ...
        if (m_target.CurrentHealth > 0)
        {
            ...
            if (m_currentActiveLB != null && m_currentActiveLB.IsActive) m_currentActiveLB.StopLogicBlock();

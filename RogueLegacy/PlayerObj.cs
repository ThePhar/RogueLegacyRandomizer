...
public class PlayerObj : CharacterObj, IDealsDamageObj
{
        ...
        ProceduralLevelScreen levelToAttachTo, Game game) : base(spriteName, physicsManager, levelToAttachTo)
    {
        ...
        m_walkDownSoundHigh =
            new FrameSoundObj(m_playerLegs, 4, "Player_WalkDown01_High", "Player_WalkDown02_High");
    ...
    public float CurrentMana
    {
        ...
        {
            m_currentMana = value;
            if (m_currentMana < 0f) m_currentMana = 0f;

            if (m_currentMana > MaxMana) m_currentMana = MaxMana;
        }
    }
    ...
    private Rectangle GroundCollisionRect => new(Bounds.X, Bounds.Y, Bounds.Width, Bounds.Height + StepUp);

    private Rectangle RotatedGroundCollisionRect => new(Bounds.X, Bounds.Y, Bounds.Width, Bounds.Height + 40);
    ...
    public Vector2 EnemyKnockBack
    {
        get
        {
            if (m_currentLogicSet == m_standingAttack3LogicSet) return StrongEnemyKnockBack;
    ...
    public float ManaGain
    {
        ...
        {
            var num = 0;
            if (Game.PlayerStats.Class == 1 || Game.PlayerStats.Class == 9) num = 6;
    ...
    public float TotalCriticalDamage
    {
        get
        {
            ...
            var @class = Game.PlayerStats.Class;
            if (@class == 3 || @class == 11) return num + 1.25f;
    ...
    public float TotalGoldBonus
    {
        get
        {
            ...
            var @class = Game.PlayerStats.Class;
            if (@class == 5 || @class == 13) return num + 0.3f;
    ...
    public float TotalMovementSpeed
    {
        ...
        {
            var num = 0f;
            if (State == 7 || State == 9) num = FlightSpeedMod;
    ...
    public float TotalMovementSpeedPercent
    {
        ...
        {
            var num = 0f;
            if (Game.PlayerStats.Traits.X == 14f || Game.PlayerStats.Traits.Y == 14f) num = 0.3f;

            return 1f + GetEquipmentSecondaryAttrib(10) + num +
                   Game.PlayerStats.GetNumberOfEquippedRunes(7) * 0.2f +
    ...
    public float ClassMoveSpeedMultiplier
    {
        ...
        {
            var @class = Game.PlayerStats.Class;
            if (@class == 4 || @class == 12) return 0.3f;

            if (@class != 16) return 0f;
    ...
    public int Damage
    {
        get
        {
            ...
            if (IsAirAttacking) num = (int) (num * TotalAirAttackDamageMod);
    ...
    protected override void InitializeEV()
    {
        ...
        if (LevelENV.EnablePlayerDebug) Speed = 1500f;
    }

    protected override void InitializeLogic()
    {
        if (m_standingAttack3LogicSet != null) m_standingAttack3LogicSet.Dispose();

        m_standingAttack3LogicSet = new LogicSet(this);
        m_standingAttack3LogicSet.AddAction(new ChangeSpriteLogicAction("PlayerAttacking3_Character", false,
            false));
        ...
        if (m_airAttackLS != null) m_airAttackLS.Dispose();
    ...
    public override void ChangeSprite(string spriteName)
    {
        ...
        if (State != 8)
        {
            ...
            if (Game.PlayerStats.SpecialItem == 8) _objectList[14].Visible = true;

            _objectList[7].Visible = true;
            if (Game.PlayerStats.Traits.X == 8f || Game.PlayerStats.Traits.Y == 8f) _objectList[7].Visible = false;
            ...
            if (Game.PlayerStats.Class == 16) _objectList[0].Visible = true;
    ...
    {
        if (!LevelENV.RunDemoVersion && !LevelENV.CreateRetailVersion) DebugInputControls();

        if (!ControlsLocked && !IsKilled && State != 3) InputControls();
    ...
    private void DebugInputControls()
    {
        ...
        if (m_debugInputMap.JustPressed(1)) CurrentMana = MaxMana;

        if (m_debugInputMap.JustPressed(3)) Game.PlayerStats.Gold += 1000;

        if (m_debugInputMap.JustPressed(4)) Game.PlayerStats.Gold += 10000;

        if (m_debugInputMap.JustPressed(6)) Game.PlayerStats.Gold += 100000;
        ...
        if (m_debugInputMap.JustPressed(8)) Game.EquipmentSystem.SetBlueprintState(1);

        if (m_debugInputMap.JustPressed(9)) Game.EquipmentSystem.SetBlueprintState(3);
    }
    ...
    private void InputControls()
    {
        ...
        if (State != 8)
        {
            if (Game.GlobalInput.Pressed(13) && CanBlock && !m_currentLogicSet.IsActive)
            {
                if (CurrentMana >= 25f)
                {
                    if (m_isTouchingGround) CurrentSpeed = 0f;
                    ...
                    State = 6;
                    if (Game.GlobalInput.JustPressed(13)) SoundManager.PlaySound("Player_Block_Action");
                }
        ...
        if (State != 6 && State != 7 && State != 8 && Game.PlayerStats.Class != 16)
        {
            ...
            else if ((Game.GlobalInput.JustPressed(10) || Game.GlobalInput.JustPressed(11)) &&
                     !m_isTouchingGround &&
        ...
        if (!m_currentLogicSet.IsActive && State != 6 && State != 8 && Game.PlayerStats.Class != 16)
        {
                ...
                Game.GameConfig.QuickDrop && State == 2 && m_dropThroughGroundTimer <= 0f)
            {
                ...
                if (Game.PlayerStats.Class == 6 || Game.PlayerStats.Class == 14) FadeSword();

                if (m_assassinSpecialActive) DisableAssassinAbility();
            ...
            else if (Game.GlobalInput.JustPressed(12))
            {
                ...
                else
                {
                    ...
                    if (m_attackCounter > 0f) m_attackNumber++;
            ...
            if (Game.GlobalInput.JustPressed(13))
            {
                    ...
                    !(currentRoom is ChestBonusRoomObj))
                {
                    ...
                    else if (Game.PlayerStats.Class == 8)
                    {
                        if (State == 8)
                            DeactivateTanooki();
                        else if (Game.GlobalInput.Pressed(18) || Game.GlobalInput.Pressed(19)) ActivateTanooki();
                    }
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        if (m_dropThroughGroundTimer > 0f) m_dropThroughGroundTimer -= num;

        if (m_ninjaTeleportDelay > 0f) m_ninjaTeleportDelay -= num;
        ...
        if (m_swearBubbleCounter > 0f)
        {
            ...
            if (m_swearBubbleCounter <= 0f) m_swearBubble.Visible = false;
        }

        if (m_blockInvincibleCounter > 0f) m_blockInvincibleCounter -= num;

        if (IsFlying)
        {
            if (State != 9) m_flightCounter -= num;
        ...
        else if (AccelerationX > 0f) AccelerationX -= 200f * num;

        if (AccelerationX < 3.6f && AccelerationX > -3.6f) AccelerationX = 0f;
        ...
        if (!m_externalLS.IsActive)
        {
            ...
            if (m_currentLogicSet.IsActive) m_currentLogicSet.Update(gameTime);

            if (m_dashCooldownCounter > 0) m_dashCooldownCounter -= gameTime.ElapsedGameTime.Milliseconds;
            ...
            if (m_invincibleCounter > 0)
            {
                ...
                if (!m_assassinSpecialActive && Opacity != 0.6f) Opacity = 0.6f;
            }
            ...
            if (!IsPaused && (m_currentLogicSet == null || !m_currentLogicSet.IsActive)) UpdateAnimationState();
            ...
            if (m_assassinSpecialActive)
            {
                ...
                if (m_assassinDrainCounter >= 0.33f)
                {
                    ...
                    CurrentMana -= 7f;
                    if (CurrentMana <= 0f) DisableAssassinAbility();
                }
            }
            ...
            if (State == 8)
            {
                ...
                if (m_tanookiDrainCounter >= 0.33f)
                {
                    ...
                    CurrentMana -= 6f;
                    if (CurrentMana <= 0f) DeactivateTanooki();
                }
            }

            if (SpellCastDelay > 0f) SpellCastDelay -= num;

            base.Update(gameTime);
            return;
        }

        if (m_externalLS.IsActive) m_externalLS.Update(gameTime);
    }
    ...
    private void UpdateAnimationState()
    {
        ...
        {
            case 0:
                if (SpriteName != "PlayerIdle_Character") ChangeSprite("PlayerIdle_Character");

                if (!IsAnimating && m_playerHead.SpriteName != "PlayerIdleHeadUp_Sprite") PlayAnimation();

                break;

            case 1:
                if (SpriteName != "PlayerWalking_Character") ChangeSprite("PlayerWalking_Character");
            ...
            case 9:
                if (AccelerationY <= 0f)
                {
                    if (SpriteName != "PlayerJumping_Character") ChangeSprite("PlayerJumping_Character");
                }
            ...
            case 3:
                if (SpriteName != "PlayerHurt_Character") ChangeSprite("PlayerHurt_Character");
            ...
            case 4:
                ...
                {
                    if (SpriteName != "PlayerDash_Character") ChangeSprite("PlayerDash_Character");
                }
                ...
                if (HeadingX > 0f && Flip == SpriteEffects.None)
                {
                    if (SpriteName != "PlayerFrontDash_Character") ChangeSprite("PlayerFrontDash_Character");
                }
                else if (HeadingX > 0f && Flip == SpriteEffects.FlipHorizontally &&
                ...
                if (!IsAnimating) PlayAnimation(false);
            ...
            case 8:
                if (SpriteName != "Tanooki_Character") ChangeSprite("Tanooki_Character");
    ...
    private void CheckGroundCollision()
    {
        ...
        foreach (var current in PhysicsMngr.ObjectList)
            if (((Game.PlayerStats.Traits.X != 33f && Game.PlayerStats.Traits.Y != 33f) || !(current is PhysicsObj) ||
                ...
                (current.CollidesTop || current.CollidesLeft || current.CollidesRight) &&
                current.HasTerrainHitBox &&
                ...
                (!current.CollidesTop || !current.CollidesBottom || current.CollidesLeft || current.CollidesRight))
            {
                ...
                if (current.Rotation == 0f || hazardObj != null)
                {
                    ...
                    if (hazardObj != null) rectangle2 = current.Bounds;
                    ...
                    if (vector2.X > 0f && current.CollidesRight) m_collidingLeft = true;

                    if (vector2.X < 0f && current.CollidesLeft) m_collidingRight = true;
                    ...
                    else if (vector3.Y != 0f) flag = true;

                    if (flag) m_collidingRightOnly = m_collidingLeftOnly = false;
        ...
        if (m_isTouchingGround)
        {
                ...
                if (Game.PlayerStats.Traits.X == 6f || Game.PlayerStats.Traits.Y == 6f)
                {
                    ...
                    if (AccelerationY > 1400f)
                    {
                        ...
                        AttachedLevel.ImpactEffectPool.DisplayDustEffect(new Vector2(TerrainBounds.Left,
                            Bounds.Bottom));
                        AttachedLevel.ImpactEffectPool.DisplayDustEffect(
                            new Vector2(TerrainBounds.X, Bounds.Bottom));
            ...
            if (State == 3) m_invincibleCounter = (int) (InvincibilityTime * 1000f);
            ...
            IsFlying = false;
            DisableGravity = false;
            if (State == 8) CurrentSpeed = 0f;

            IsJumping = false;
            m_doubleJumpCount = 0;
            if (State != 6 && State != 8 && State != 4) State = 0;
        ...
        if (State != 4)
        {
                    ...
                    collisionObj.TerrainBounds, collisionObj.Rotation, Vector2.Zero).Y < 0f)
            {
                ...
                if (collisionObj.Width > collisionObj.Height)
                {
                    ...
                    if (num > vector.X && num < vector2.X) flag = true;
                }
    ...
    public override void CollisionResponse(CollisionBox thisBox, CollisionBox otherBox, int collisionResponseType)
    {
            ...
            else
            {
                ...
                if (linkedRoom != null)
                    foreach (var current in linkedRoom.DoorList)
                        ...
                        {
                            if (linkedRoom is LastBossChallengeRoom) linkedRoom.LinkedRoom = AttachedLevel.CurrentRoom;
        ...
        {
            if (breakableObj != null && !breakableObj.Broken) breakableObj.Break();
             ...
             physicsObj.CollisionTypeTag == 4 || physicsObj.CollisionTypeTag == 10))
        {
            ...
            var flag = true;
            if (m_dropThroughGroundTimer > 0f && !physicsObj.CollidesBottom && physicsObj.CollidesTop) flag = false;
            ...
            if (!physicsObj.CollidesBottom && physicsObj.CollidesTop && (State == 7 || State == 9)) flag = false;
            ...
            if (flag) base.CollisionResponse(thisBox, otherBox, collisionResponseType);

            if (vector3.Y != 0f && otherBox.AbsRotation != 0f) X -= vector3.X;
        }
             ...
             physicsObj.CollisionTypeTag == 10) && State != 3 && m_invincibleCounter <= 0)
        {
            ...
            if (enemyObj != null && enemyObj.IsDemented) return;

            var projectileObj = physicsObj as ProjectileObj;
            if (projectileObj != null && projectileObj.IsDemented) return;
    ...
    {
        if (m_currentLogicSet != null && m_currentLogicSet.IsActive) m_currentLogicSet.Stop();
    ...
    public void HitPlayer(GameObj obj)
    {
        var flag = true;
        if (obj is HazardObj &&
            ((Game.PlayerStats.SpecialItem == 4 && obj.Bounds.Top > Y) || InvincibleToSpikes)) flag = false;
        ...
        if (enemyObj2 != null && enemyObj2.IsDemented) flag = false;
        ...
        if (flag && (!ForceInvincible || (ForceInvincible && obj is HazardObj)))
        {
            ...
            if (!Game.PlayerStats.TutorialComplete) num = 0;
            ...
            if (enemyObj3 != null && CurrentHealth > 0)
            {
                ...
                if (num2 > 0) enemyObj3.HitEnemy(num2, enemyObj3.Position, true);
            }
            ...
            if (projectileObj != null && projectileObj.CollisionTypeTag == 3)
            {
                ...
                if (enemyObj4 != null && !enemyObj4.IsKilled && !enemyObj4.IsDemented && CurrentHealth > 0)
                {
                    ...
                    if (num3 > 0) enemyObj4.HitEnemy(num3, enemyObj4.Position, true);
                }
            }
            ...
            if (CanBeKnockedBack)
            {
                ...
                CurrentSpeed = 0f;
                var num5 = 1f;
                if (Game.PlayerStats.Traits.X == 10f || Game.PlayerStats.Traits.Y == 10f) num5 = 1.85f;

                if (Game.PlayerStats.Traits.X == 9f || Game.PlayerStats.Traits.Y == 9f) num5 = 0.5f;
    ...
    public void RunDeathAnimation1()
    {
        ...
        PlayAnimation(false);
        if (_objectList[0].Visible) Tween.To(_objectList[0], 0.5f, Tween.EaseNone, "delay", "0.5", "Opacity", "0");
    }
    ...
    public void RunDeathAnimation2()
    {
        ...
        PlayAnimation();
        if (_objectList[0].Visible) Tween.To(_objectList[0], 1f, Tween.EaseNone, "delay", "0.5", "Opacity", "0");
    }
        ...
        if (State != 8)
            for (var i = 0; i < Game.PlayerStats.GetEquippedArray.Length; i++)
            {
                ...
                if (num != -1)
                {
                    ...
                    if (partIndices.X != -1f) GetChildAt((int) partIndices.X).TextureColor = equipmentData.FirstColour;

                    if (partIndices.Y != -1f) GetChildAt((int) partIndices.Y).TextureColor = equipmentData.SecondColour;

                    if (partIndices.Z != -1f) GetChildAt((int) partIndices.Z).TextureColor = equipmentData.SecondColour;

                    if (i == 2 && partIndices.X != -1f) GetChildAt(5).TextureColor = equipmentData.FirstColour;
                }
                else
                {
                    var partIndices2 = PlayerPart.GetPartIndices(i);
                    if (partIndices2.X != -1f) GetChildAt((int) partIndices2.X).TextureColor = Color.White;

                    if (partIndices2.Y != -1f) GetChildAt((int) partIndices2.Y).TextureColor = Color.White;

                    if (partIndices2.Z != -1f) GetChildAt((int) partIndices2.Z).TextureColor = Color.White;

                    if (i == 2) GetChildAt(5).TextureColor = Color.White;
                    ...
                    {
                        if (partIndices2.X != -1f) GetChildAt((int) partIndices2.X).TextureColor = Color.Red;

                        if (partIndices2.Y != -1f) GetChildAt((int) partIndices2.Y).TextureColor = Color.Red;
                    }
        ...
        switch (b)
        {
            ...
            case 15:
                if (CurrentMana >= num && !activateSecondary)
                {
                    ...
                    if (spell == 8 && Flip == SpriteEffects.FlipHorizontally) projectileObj.AltX = -xValue;
            ...
            case 11:
                ...
                else if (CurrentMana >= num && !activateSecondary)
                {
                    ...
                    if (megaSpell) m_megaDamageShieldCast = true;
            ...
            default:
                if (b == 100)
                    if (CurrentMana >= num && !activateSecondary)
                    {
                        ...
                        projectileObj7.Y = Y;
                        projectileObj7.Scale =
                            new Vector2(AttachedLevel.CurrentRoom.Width / projectileObj7.Width, 0f);
    ...
    public override void Draw(Camera2D camera)
    {
        ...
        if (Game.PlayerStats.IsFemale) _objectList[13].Draw(camera);
    ...
    public int GetEquipmentDamage()
    {
        ...
        for (var i = 0; i < getEquippedArray.Length; i++)
        {
            ...
            if (b > -1) num += Game.EquipmentSystem.GetEquipmentData(num2, b).BonusDamage;
    ...
    public int GetEquipmentMana()
    {
        ...
        {
            var b = getEquippedArray[i];
            if (b > -1) num += Game.EquipmentSystem.GetEquipmentData(num2, b).BonusMana;
    ...
    public int GetEquipmentHealth()
    {
        ...
        {
            var b = getEquippedArray[i];
            if (b > -1) num += Game.EquipmentSystem.GetEquipmentData(num2, b).BonusHealth;
    ...
    public int GetEquipmentArmor()
    {
        ...
        {
            var b = getEquippedArray[i];
            if (b > -1) num += Game.EquipmentSystem.GetEquipmentData(num2, b).BonusArmor;
    ...
    public int GetEquipmentWeight()
    {
        ...
        {
            var b = getEquippedArray[i];
            if (b > -1) num += Game.EquipmentSystem.GetEquipmentData(num2, b).Weight;
    ...
    public int GetEquipmentMagicDamage()
    {
        ...
        {
            var b = getEquippedArray[i];
            if (b > -1) num += Game.EquipmentSystem.GetEquipmentData(num2, b).BonusMagic;
        ...
        for (var i = 0; i < getEquippedArray.Length; i++)
        {
            ...
            if (b > -1)
            {
                ...
                for (var j = 0; j < secondaryAttribute.Length; j++)
                {
                    ...
                    if ((int) vector.X == secondaryAttribType) num += vector.Y;
                }
            }

// Rogue Legacy Randomizer - IntroRoomObj.cs
    ...
    public class IntroRoomObj : RoomObj
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (m_inSecondPart && m_smokeCounter < 0.2f)
            {
                ...
                {
                    m_smokeCounter = 0f;
                    Player.AttachedLevel.ImpactEffectPool.DisplayMassiveSmoke(
                        new Vector2(Player.AttachedLevel.Camera.X + 300f, Player.AttachedLevel.Camera.Bounds.Top));
                    Player.AttachedLevel.ImpactEffectPool.DisplayMassiveSmoke(

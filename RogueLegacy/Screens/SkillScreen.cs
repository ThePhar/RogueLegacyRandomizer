...
public class SkillScreen : Screen
{
    ...
    public override void OnEnter()
    {
        ...
        foreach (var s in skillArray)
        {
            if (s.Trait >= SkillType.ManorGroundRoad)
            {
                ...
                else if ((item.Flags & ItemFlags.NeverExclude) != 0)
                    s.Description += "It looks like something that could be of use.";
                else if ((item.Flags & ItemFlags.Trap) != 0)
                    s.Description += "It looks like something that would ruin their day.";
            }
    ...
    public static string GetSkillPlateIcon(long item)
    {
        return item switch
        {
            ItemCode.BLACKSMITH             => SkillSystem.GetSkill(SkillType.Smithy).IconName,
            ItemCode.ARCHITECT              => SkillSystem.GetSkill(SkillType.Architect).IconName,
            ItemCode.ENCHANTRESS            => SkillSystem.GetSkill(SkillType.Enchanter).IconName,
            ItemCode.PROGRESSIVE_KNIGHT     => SkillSystem.GetSkill(SkillType.KnightUp).IconName,
            ItemCode.PROGRESSIVE_MAGE       => SkillSystem.GetSkill(SkillType.MageUp).IconName,
            ItemCode.PROGRESSIVE_BARBARIAN  => SkillSystem.GetSkill(SkillType.BarbarianUp).IconName,
            ItemCode.PROGRESSIVE_KNAVE      => SkillSystem.GetSkill(SkillType.AssassinUp).IconName,
            ItemCode.PROGRESSIVE_SHINOBI    => SkillSystem.GetSkill(SkillType.NinjaUnlock).IconName,
            ItemCode.PROGRESSIVE_MINER      => SkillSystem.GetSkill(SkillType.BankerUnlock).IconName,
            ItemCode.PROGRESSIVE_LICH       => SkillSystem.GetSkill(SkillType.LichUnlock).IconName,
            ItemCode.PROGRESSIVE_SPELLTHIEF => SkillSystem.GetSkill(SkillType.SpellswordUnlock).IconName,
            ItemCode.DRAGON                 => SkillSystem.GetSkill(SkillType.SuperSecret).IconName,
            ItemCode.TRAITOR                => SkillSystem.GetSkill(SkillType.Traitorous).IconName,
            ItemCode.HEALTH                 => SkillSystem.GetSkill(SkillType.HealthUp).IconName,
            ItemCode.MANA                   => SkillSystem.GetSkill(SkillType.ManaUp).IconName,
            ItemCode.ATTACK                 => SkillSystem.GetSkill(SkillType.AttackUp).IconName,
            ItemCode.MAGIC_DAMAGE           => SkillSystem.GetSkill(SkillType.MagicDamageUp).IconName,
            ItemCode.ARMOR                  => SkillSystem.GetSkill(SkillType.ArmorUp).IconName,
            ItemCode.EQUIP                  => SkillSystem.GetSkill(SkillType.EquipUp).IconName,
            ItemCode.CRIT_CHANCE            => SkillSystem.GetSkill(SkillType.CritChanceUp).IconName,
            ItemCode.CRIT_DAMAGE            => SkillSystem.GetSkill(SkillType.CritDamageUp).IconName,
            ...
            ItemCode.RUNE_SKY               => SkillSystem.GetSkill(SkillType.Enchanter).IconName,
            ItemCode.RUNE_SIPHON            => SkillSystem.GetSkill(SkillType.Enchanter).IconName,
            ItemCode.RUNE_RETALIATION       => SkillSystem.GetSkill(SkillType.Enchanter).IconName,
            ItemCode.RUNE_BOUNTY            => SkillSystem.GetSkill(SkillType.Enchanter).IconName,
            ItemCode.RUNE_HASTE             => SkillSystem.GetSkill(SkillType.Enchanter).IconName,
            ItemCode.RUNE_CURSE             => SkillSystem.GetSkill(SkillType.Enchanter).IconName,
            ItemCode.RUNE_GRACE             => SkillSystem.GetSkill(SkillType.Enchanter).IconName,
            ItemCode.RUNE_BALANCE           => SkillSystem.GetSkill(SkillType.Enchanter).IconName,
            ItemCode.TRIP_STAT_INCREASE     => SkillSystem.GetSkill(SkillType.MagicDamageUp).IconName,
            ItemCode.GOLD_1000              => "Icon_Gold_Flat_BonusLocked_Sprite",
            ItemCode.GOLD_3000              => "Icon_Gold_Flat_BonusLocked_Sprite",
            ItemCode.GOLD_5000              => "Icon_Gold_Flat_BonusLocked_Sprite",
            ItemCode.EQUIPMENT_PROGRESSIVE  => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_SQUIRE       => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_SILVER       => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_GUARDIAN     => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_IMPERIAL     => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_ROYAL        => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_KNIGHT       => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_RANGER       => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_SKY          => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_DRAGON       => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_SLAYER       => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_BLOOD        => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_SAGE         => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_RETRIBUTION  => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_HOLY         => "Icon_BootsLocked_Sprite",
            ItemCode.EQUIPMENT_DARK         => "Icon_BootsLocked_Sprite",
            _                               => "Icon_APLocked_Sprite"
        };
    }
    ...
    public void CheckForSkillUnlock(SkillObj skill, bool displayScreen, Tuple<int, int> manorPiece = null)
    {
        ...
        switch (skill.Trait)
        {
            ...
            case SkillType.AssassinUp:
                b = 12;
                if (Game.PlayerStats.Class == 3) Game.PlayerStats.Class = 11;

                break;

            case SkillType.BankerUp:
                b = 13;
                if (Game.PlayerStats.Class == 5) Game.PlayerStats.Class = 13;
            ...
            case SkillType.NinjaUp:
                b = 11;
                if (Game.PlayerStats.Class == 4) Game.PlayerStats.Class = 12;
    ...
    {
        if (_shookLeft) _shakeObj.X += _shakeAmount;

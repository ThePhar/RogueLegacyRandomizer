...
namespace RogueLegacy.Screens
{
    public class GetItemScreen : Screen
    {
        ...
        public static string GetSkillPlateIcon(long item, out string itemName)
        {
            ...
            {
                return SkillSystem.GetSkill(SkillType.InvulnTimeUp).IconName.Replace("Locked", "");
            }
            ...
            {
                return SkillSystem.GetSkill(SkillType.RandomChildren).IconName.Replace("Locked", "");
            }
        ...
        private string GetStatText(int type)
        {
            return type switch
            {
                (int) ItemDropType.StatStrength  => "Strength Increased: +" + 2,
                (int) ItemDropType.StatMagic     => "Magic Damage Increased: +" + 2,
                (int) ItemDropType.StatDefense   => "Armor Increased: +" + 4,
                (int) ItemDropType.StatMaxHealth => "HP Increased: +" + 10,
                (int) ItemDropType.StatMaxMana   => "MP Increased: +" + 10,
                (int) ItemDropType.StatWeight    => "Max Weight Load Increased: +" + 10,
                _                                => ""
            };
        }
